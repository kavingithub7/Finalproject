        ...
        <div className="specification">
            ...
            <div className="specificationcontent">
                <div className="features1">
                    <div className="feature1logo"><span className='forlogo'><svg xmlns="http://www.w3.org/2000/svg"  width="55" height="65"  fill=" #c11b69" class="bi bi-phone" viewBox="0 0 16 16">
