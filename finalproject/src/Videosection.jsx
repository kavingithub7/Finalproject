...
export default function Videosection()
{
  ...
  <path d="M10.804 8 5 4.633v6.734zm.792-.696a.802.802 0 0 1 0 1.392l-6.363 3.692C4.713 12.69 4 12.345 4 11.692V4.308c0-.653.713-.998 1.233-.696z"/>
            ...
            <div className="clients">
                ...
                <div className="cupicon">
                        <span className="coffeeicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#e31374" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                ...
                <div className="cupicon">
                        <span className="coffeeicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#e31374" class="bi bi-emoji-smile" viewBox="0 0 16 16">
  ...
  <path d="M4.285 9.567a.5.5 0 0 1 .683.183A3.5 3.5 0 0 0 8 11.5a3.5 3.5 0 0 0 3.032-1.75.5.5 0 1 1 .866.5A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1-3.898-2.25.5.5 0 0 1 .183-.683M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5m4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5"/>
                ...
                <div className="cupicon">
                        <span className="coffeeicon"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#e31374" class="bi bi-award" viewBox="0 0 16 16">
